...
@HACK 0x0045571B,0x00455729,_BuildingClass_ShapeNumber_RemoveTeslaIDCheck
...
@HACK 0x00460414,0x00460422,_BuildingClass_AnimationAI_IncludeAllChargingBuildings
    TechnoTypeClass.PrimaryWeapon.Get(eax,eax)
    cmp  eax,0x0
    jz   0x00460433
    test byte[eax+0x8],0x8 ; Charges
...
@HACK 0x0045FCC7,0x0045FCCD,_BuildingClass_ChargingAI_Jammed_PreventsCharge
    jz   0x0045FDCA
...
@HACK 0x0045FCF1,0x0045FCF9,_BuildingClass_ChargingAI_UseActiveAnimCount
...
@HACK 0x0045FDA7,0x0045FDAE,_BuildingClass_ChargingAI_UnhardcodeRate
    push ecx
    push edx
    push eax
    xor  edx,edx
...
@HACK 0x0045FDAE,0x0045FDB3,_BuildingClass_ChargingAI_UseWeaponChargeVoice
    push ecx
    push edx
    xor  edx,edx
    lea  eax,[ebx+0xCD]

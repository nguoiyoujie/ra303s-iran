...
@HACK 0x004CEDF5,0x004CEDFA,_TFixedHeapClass__HouseClass__Load_HouseClass
...
@HACK 0x004CEE10,0x004CEE15,_TFixedHeapClass__HouseClass__Load_Clear_Memory_For_Old_Savegames

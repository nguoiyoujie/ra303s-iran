...
@LJMP 0x0058FB6D, _WarheadTypeClass__Read_INI_MoveNewOffsets_ExplosionSet_InfantryDeath
@LJMP 0x0058FC04, _WarheadTypeClass__Read_INI_Expand_Modifier_5_to_9
@LJMP 0x004EBF1D, _Combat_InfantryDeathCheck
@LJMP 0x004A37BC, _Combat_ExplosionSetCheck
@LJMP 0x005900C0, _ArmorType_NameFrom_Expand_Array
@LJMP 0x005900D4, _ArmorType_NameFrom_Expand_Array2

...
@HACK 0x0045DFF3,0x0045DFFF,_BuildingClass_Mission_Unload_WeaponsFactoryOpening
    movzx eax,al
...
@HACK 0x0045E0C1,0x0045E0CB,_BuildingClass_Mission_Unload_WeaponsFactory_OpenDoor
...
@HACK 0x0045E237,0x0045E241,_BuildingClass_Mission_Unload_WeaponsFactory_CloseDoor1
    mov  ebx,dword[Cache_WarFactory_DoorStages]
    mov  edx,dword[Cache_WarFactory_DoorRate]
    jmp  0x0045E241
@ENDHACK
...
@HACK 0x0045E033,0x0045E040,_BuildingClass_Mission_Unload_WeaponsFactory_CalculateSouthCell
...
@HACK 0x0045E20D,0x0045E212,_BuildingClass_Mission_Unload_WeaponsFactory_ForceTrack
...
@HACK 0x0045E25D,0x0045E267,_BuildingClass_Mission_Unload_WeaponsFactory_CloseDoor2
    mov  ebx,dword[Cache_WarFactory_DoorStages]
    mov  edx,dword[Cache_WarFactory_DoorRate]
    jmp  0x0045E267
@ENDHACK
...
@HACK 0x00455412,0x0045541A,_BuildingClass_Draw_It_WeaponsFactoryDoor
    movzx eax,al
    BuildingTypeClass.FromIndex(eax,eax)
    test eax,eax
    jz   0x0045541A
...
@HACK 0x00455442,0x0045544A,_BuildingClass_Draw_It_WeaponsFactoryDoorFake
    movzx eax,al
...
@HACK 0x00455477,0x0045547C,_BuildingClass_Draw_It_WeaponsFactoryDoor2
    jz   0x0045547C
...
@HACK 0x00455491,0x00455497,_BuildingClass_Draw_It_WeaponsFactoryDoor3
...
;@HACK 0x00458DCD,_BuildingClass_ExitObject_Factories
;    cmp  al,0xC
...
@HACK 0x00458F42,0x00458F4A,_BuildingClass_ExitObject_Factories2
    movzx eax,al
    BuildingTypeClass.FromIndex(eax,eax)
    cmp  byte[eax+BuildingTypeClass.Offset.FactoryType],RTTIType.UnitType 
    jnz  0x00458ED8 
...
@HACK 0x00459004,0x00459009,_BuildingClass_ExitObject_FactoriesSetFacing

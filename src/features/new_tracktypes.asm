...
@HACK 0x004B6A76,0x004B6A7B,_DriveClass_TrackControl_Route
...
@HACK 0x004B6AA4,0x004B6AAD,_DriveClass_RawTracks_Route
...
@HACK 0x004B82E5,0x004B82EC,_DriveClass_Mark_Track_TrackControl_Route
...
@HACK 0x004B82F7,0x004B8300,_DriveClass_Mark_Track_RawTracks_Route
    ; eax is tracknum (note 'tracknum-1' is implemented by offsetting with 0x00600FEC instead of 0x00600FFC. Reroute if larger than to the original count 13

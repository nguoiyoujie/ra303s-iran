...
@HACK 0x0058FB6D,0x0058FBA3,_WarheadTypeClass__Read_INI_MoveNewOffsets_ExplosionSet_InfantryDeath
    ...
    WarheadTypeClass.ExplosionAnim.Read(esi,edi,_GetAnimTypeFromString)
...
@HACK 0x0058FC04,0x0058FC09,_WarheadTypeClass__Read_INI_Expand_Modifier_5_to_11
...
.Continue:
    cmp  dl,ArmorType.MAX+1
    jl   0x0058FBDC
    jmp  0x0058FC09
@ENDHACK


@HACK 0x004EBF1D,0x004EBF2B,_InfantryClass__Take_Damage_InfantryDeathCheck
    mov  byte al,[eax+WarheadTypeClass.Offset.InfantryDeath] ;  use new offset
    movzx eax,al
    xor  edi,edi
    cmp  eax,0x5
    ja   0x004EC066
...
@HACK 0x005900C0,0x005900C7,_ArmorType_NameFrom_Expand_Array
    cmp  dl,ArmorType.MAX+1 ;change to 11 when class size is expanded
    jl   0x005900CC
    jmp  0x005900E9
@ENDHACK

...
cglobal Clear_Extended_Savegame_Values
...
@HACK 0x00539106,0x0053910E,_Load_Misc_Values_Extended_Savegames
    ...
    jnz  .Ret ; Globals___SaveGameVersion != New_Savegame_Version so return
...
%macro Clear_Extended_Class_Memory_For_Old_Saves 3
    cmp  dword[Globals___SaveGameVersion],New_Savegame_Version
    jz   .Ret ; Globals___SaveGameVersion == New_Savegame_Version so return
    Save_Registers

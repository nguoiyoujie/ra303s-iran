...
;   WHITE
    ...
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+0x0],0x0F
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+0x1],0x0F ; Name in radar logo color bits, this is for a yellow name
    ; Remap colours for name in the name list on the radar
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+268],0x0F
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+269],0x0E
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+270],0x0F
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+271],0x0E
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+272],0x0F
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+273],0x0E
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+274],0x0F
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+275],0x0E
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+276],0x0F
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+277],0x0E
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+278],0x0F
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+279],0x0E
    ...
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+82],0x0F ; 15
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.White.Offset+83],0x0F ; 15
...
;   BLACK
    ...
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.Black.Offset+0x0],0x0F
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.Black.Offset+0x1],0x0F ; Name in radar logo color bits, this is for a yellow name
    ; Remap colours for name in the name list on the radar
    ...
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.Black.Offset+96],0x0C ; 12
    mov  byte [ColorRemaps.ExtendedColors+ColorRemaps.Black.Offset+97],0x0C ; 12

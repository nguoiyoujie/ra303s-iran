...
cextern Globals___Scen_Difficulty
cextern Globals___Scen_CDifficulty
cextern Globals___Scen_ScenarioName
cextern Globals___Map
cextern Globals___BlackPalette
cextern Globals___WhitePalette
cextern Globals___Session_Type
cextern Globals___Session_MaxAhead
cextern Globals___Session_FrameSendRate
cextern Globals___Ipx
cextern Globals___Seed
cextern Globals___CustomSeed
cextern Globals___VisiblePage
cextern Globals___HiddenPage
cextern Globals___UnitBuildPenalty
cextern Internet___PlanetWestwoodGameID
cextern Internet___PlanetWestwoodStartTime
...
cextern str_HouseColors
cextern str_HouseCountries
cextern str_HouseHandicaps
cextern str_IsSpactator
cextern str_Multi1
cextern str_Multi2
cextern str_Multi3
cextern str_Multi4
...
cextern str_Bases
cextern str_Credits
cextern str_OreRegenerates
cextern str_Crates
cextern str_UnitCount
cextern str_ALPlayers
cextern str_SlowUnitBuild
cextern str_CaptureTheFlag
cextern str_ShroudRegrows
cextern str_TechLevel
cextern str_AIDifficulty
cextern str_Aftermath
cextern str_Name
cextern str_Side
cextern str_Color
cextern str_fmt_Other
cextern str_GameSpeed
cextern str_NetworkVersionProtocol
cextern str_MaxAhead
cextern str_FrameSendRate
cextern str_GameID
cextern str_Scenario
cextern str_AftermathFastBuildSpeed
cextern str_FixFormationSpeed
cextern str_FixRangeExploit
cextern str_FixMagicBuild
cextern str_ParabombsInMultiplayer
cextern str_FixAIAlly
cextern str_MCVUndeploy
cextern str_AllyReveal
cextern str_ForcedAlliances
cextern str_TechCenterBugFix
cextern str_BuildOffAlly
cextern str_SouthAdvantageFix
cextern str_NoScreenShake
cextern str_NoTeslaZapEffectDelay
cextern str_ShortGame
cextern str_DeadPlayersRadar
cextern str_FixAIParanoid
cextern str_LoadSaveGame
cextern str_SaveGameNumber
cextern str_IsSinglePlayer
...
.first_run:
    ...
    mov  [Globals___Session_Type+Session.type],byte 5 ; Set to type skirmish

    mov  [Globals___Session_Type+Session.protocol],byte 2
    mov  [Globals___Session_Type+Session.mission],dword 0
...
.next_opp:
    ...
    mov  [Globals___Session_Type+Session.type],byte 4

@LJMP 0x0054BA32, _Conditionally_Load_Missions_PKT
@LJMP 0x0054BD30, _Patch_Out_Counterstrike_Installed_Check
@LJMP 0x0054BD3D, _Conditionally_Load_Cstrike_PKT
@LJMP 0x0054BE9E, _Patch_Out_Aftermath_Installed_Check
@LJMP 0x0054BEAB, _Conditionally_Load_Aftmath_PKT

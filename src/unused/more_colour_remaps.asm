...
;@LJMP 0x0053E052, _Assign_Houses_Color_Remaps_Indexes
;@LJMP 0x0053E069, _Assign_Houses_Color_Remaps_Index_Check
;@LJMP 0x0053DFCE, _Assign_Houses_Color_Remaps_Index_Check2
;@LJMP 0x0053B81D, _Assign_Houses_Colour_Remaps_Cleanup
;@LJMP 0x0053E158, _Assign_Houses_Colour_Remaps_NULL_Check
